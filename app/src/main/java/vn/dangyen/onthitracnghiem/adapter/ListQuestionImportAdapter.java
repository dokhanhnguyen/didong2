...
public class ListQuestionImportAdapter extends ArrayAdapter<Question> {
    public ListQuestionImportAdapter(@NonNull Context context, ArrayList<Question> arrQuestion) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (question != null) {
            ...
            if (QuizImportActivity.checkResult){
